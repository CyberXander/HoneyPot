...
const SynFloodLogger = require('./lib/doslogger');
...
//Catching DOS synflood request using tcpdump
const dos = new SynFloodLogger().on('data', (data) => {
	emitData(data);
});
...
const server_port = config.nginx_reverse_proxy === true ? config.express_js_alternative_port : 9000;
